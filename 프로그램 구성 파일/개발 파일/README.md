...
릴스, 유튜브 영상, 또는 내 컴퓨터의 동영상 파일을 OpenAI API로 전사하고, 읽기 쉬운 TXT 스크립트 파일로 저장하는 Windows 데스크톱 앱입니다.
...
작업이 끝나면 `생성된 노트` 폴더 바로 아래에 영상과 TXT가 같은 이름으로 저장됩니다. 영상별 하위 폴더는 만들지 않습니다.
